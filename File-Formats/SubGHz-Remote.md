...
### The UniRF Tool *requires* the creation of custom user map with `.txt` extension in the `subghz/unirf` folder on the sdcard.
...
## Setting up the `subghz/unirf/example.txt` file:
